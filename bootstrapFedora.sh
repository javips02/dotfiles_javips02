...
sudo dnf update
sudo dnf install polkit-gnome gnome-keyring qt5-qtwayland qt6-qtwayland mako xdg-desktop-portal-hyprland hyprpaper waybar hypridle xwaylandvideobridge
