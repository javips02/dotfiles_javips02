...
eval "$(rbenv init - zsh)"
#Unizar
alias fastfetch="clear && fastfetch --logo ~/.config/fastfetch/logo.png --logo-type kitty-direct --logo-width 50 --logo-height 20"
alias v="nvim"
...
alias JAVA_HOME="/opt/homebrew/opt/openjdk@17/"
#ADSIS2
